...
class Graph {
	...
	int frienddfs[], friendbfs[], friendstart[];
	...
	void BFS(int s)
    {
		...
		sumbfs +=piecesbfs[s];
		friendbfs[position]= piecesbfs[s];
		piecesbfs[s] = 0;
	...
	void DFS(int v)
	{
		...
		frienddfs[position]= piecesdfs[v];
		piecesdfs[v] = 0;
		DFSUtil(v, visited);
	}
	...
	public static void main(String args[])
	{
		...
		try{
			PrintStream writer = new PrintStream(new File("sample.txt"));
